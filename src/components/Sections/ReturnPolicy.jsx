...
import data from "@data/returnPolicy.json";
import icon1 from "@assets/icons/return-policy/1.svg";
import icon2 from "@assets/icons/return-policy/2.svg";
import icon3 from "@assets/icons/return-policy/3.svg";
